...
token = "Jmeqq2uWHNAE1wDNhfN90g9Tdjy76uhDz8wSWXw_qagBfzHE4ucBwOaWTZVx_gb9eMLQ-FitnCr-a6CJ7wcPYA=="
url = "http://influxdb:8086"
bucket = "iba_data_16mm"

print(org, token, url, bucket)
...
class LinearFlow(FlowSpec):
    ...
    def push_to_influx(self, df, measurement_name):
        try:
            ...
            print("----------In push to influx-----------", df.head())
            ...
            with client.write_api(write_options=wo) as write_client:
                ...
                print(f"An error occurred while pushing data to InfluxDB: {e}")
    ...
    def get_anomaly_scores(self):
        try:
            ...
            print("----------df_normlaized columns:---------", relevant_columns1)
            ...
            relevant_weights1_array = relevant_weights1.values.flatten()
            print("----------relevant weights:---------", relevant_weights1)
            ...
            weighted_diff = abs_diff * relevant_weights1_array
            ...
            print("----------Printing head of anomaly SCORE DF-------------------",self.anomaly_score_df.head())
        
        except Exception as e:
            logger.error(f"The region is: {self.region_name}")
            logger.error(f"An error occurred in get_anomaly_scores step: {e}")
            print(f"An error occurred in get_anomaly_scores step: {e}")
